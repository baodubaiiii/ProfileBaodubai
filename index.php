...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            <div class="medias">
                <video class="item_video" autoplay loop muted playsinline>
                    <source src="./res/v5/files/video/yasuo.mp4" type="video/mp4">
                </video>
                <div class="date"></div>
            </div>
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="./res/v5/img/2.jpg" alt="">
    ...
    <main id="td-main">
        ...
        <section class="td-content">
            <div class="about-me">
                ...
                <div class="avatar">
                    <img class="avatar-img" src="<?=$ThanhDieuHeader->avatar?>?v=<?=rand(1,999)?>" alt="">
    ...
    <footer id="footer">
        <span>
            <a href="//thanhdieu.com" target="_blank">&copy; Copyright&nbsp;BaoDubai 2025</a>
        </span>
    </footer>
